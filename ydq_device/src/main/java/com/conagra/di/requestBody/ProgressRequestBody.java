package com.conagra.di.requestBody;
...
public class ProgressRequestBody extends RequestBody {
    ...
    //进度回调接口
    private final FealHeartCreate.UploadProgressListener progressListener;
    //包装完成的BufferedSink
    private BufferedSink bufferedSink;

    public ProgressRequestBody(RequestBody requestBody, FealHeartCreate.UploadProgressListener progressListener) {
