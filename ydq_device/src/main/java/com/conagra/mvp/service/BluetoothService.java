...
//						if(getRecordStatus()) {
//							recordFinished();
//							LogMessage.doLogMessage("aa","");
////							Toast.makeText(, getResources().getString(R.string.record_finished), Toast.LENGTH_SHORT).show();
//						} else {
//							recordStart();
//							LogMessage.doLogMessage("aa","");
////							Toast.makeText(this, getResources().getString(R.string.record_start), Toast.LENGTH_SHORT).show();
//						}
//					} else {
//						LogMessage.doLogMessage("aa","");
////						Toast.makeText(this, getResources().getString(R.string.start_bluetooth_connect), Toast.LENGTH_SHORT).show();
//					}
					break;
...
//	}
	...
	class LMTPDListener implements LMTPDecoderListener {
		...
		public void fhrDataChanged(FhrData fhrData) {
			...
			LogMessage.doLogErrorMessage("FetalHeartActivity13","fhrDataChanged : " + infor);
			...
			if(mCallback != null)
				mCallback.dispInfor(fhrData.fhr1 + "");
		}
