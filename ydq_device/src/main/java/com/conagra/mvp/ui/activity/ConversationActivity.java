...
import com.conagra.mvp.ui.fragment.ConversationFragmentEx;
...
//            setTitle(R.string.de_actionbar_sub_defult);
    ...
    private void enterSettingActivity() {
        ...
        if (mConversationType == Conversation.ConversationType.PUBLIC_SERVICE
            ...
            @SuppressLint("RestrictedApi") UriFragment fragment = (UriFragment) getSupportFragmentManager().getFragments().get(0);
            //得到讨论组的 targetId
...
//
//        IMNetWorkRequest.getGroupMemberList(mTargetId,new MySubscriber<IMMemberListBean>(IMMemberListBean.class){
//            @Override
...
//
//            @Override
//            public void onBackNext(IMMemberListBean obj) {
//                super.onBackNext(obj);
//                ArrayList<String> userIds = new ArrayList<>();
//                userIds.add(BaseApplication.getmUserModel().getCustomerNo());
//                if(obj != null && null != obj.getData()){
//                    for(IMMemberListBean.DataBean bean:obj.getData()){
//                        if(bean != null){
//                            userIds.add(bean.getCode());
//                        }
//                    }
//                }
////                    Group groupInfo = new Group(groupsId, group.getName(), Uri.parse(group.getPortraitUri()));
...
//        IMNetWorkRequest.getGroupFormMember(this,"001", BaseApplication.getmUserModel().getCustomerNo(),new MySubscriber<ImFriendsBean>(ImFriendsBean.class){
//            @Override
//            public void onBackError(String message) {
//                super.onBackError(message);
//                mCallMemberResult.onGotMemberList(null);
...
//
//            @Override
//            public void onBackNext(ImFriendsBean obj) {
//                super.onBackNext(obj);
//                ArrayList<String> userIds = new ArrayList<>();
//                userIds.add(BaseApplication.getmUserModel().getCustomerNo());
//                if(obj != null && null != obj.getData()){
//                    for(ImFriendsBean.DataBean bean:obj.getData()){
//                        if(bean != null){
